...
% system parameters
g = 9.81;
l = 0.5836;  %effective length 
a = 1/0.0522;           %nominal motor parameters
b = 0.00269;        %nominal motor parameters
...
p1 = -3 + 1*i   % dominant pole pair
p2 = -3 -1*i    % dominant pole pair 
p3 = -10
p4 = -8    % dominant pole pair
